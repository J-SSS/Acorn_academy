...
public class HashCodeTest {
	public static void main(String[] args) {
		...
		System.out.println(w2.hashCode());	// 서로 다름
		...
		System.out.println(s2.hashCode());	// 서로 같음 (String 클래스에서 오버라이딩됨)
		
		Integer i = -100; // Integer의 경우 hash값을 찍어보면, 할당한 정수값이 출력됨(오버라이딩됐기 때문)
